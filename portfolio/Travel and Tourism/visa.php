    ...
    <div class="contents">
        <div class="text">
            <h1>تأمين تأشيرة</h1>
                ...
                <ol>
                    <lh>يوجد لدينا العديد من التأشيرات منها:</lh>
                    <li>تأشيرات السياحية</li>
                    <li>تأشيرات العمل</li>
                    <li>تأشيرات المستثمرين</li>
                </ol>
                <ol>
                    <lh>نتميز عن منافسينا:</lh>
                    <li>سرعة في انجاز التأشيرة</li>
                    <li>أفضل الاسعار المدروسة</li>
                    <li>مستوى عال من الامان والمصداقية</li>
                </ol>
            
        </div>
        <div class="pic"><img src="img/pic01.jpg"></div>
    </div>
    <!--end contents -->
    <table class="table">
