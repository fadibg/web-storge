<!DOCTYPE html>
    ...
    <div class="contents">
        <div class="text">
            <h1>برنامج سياحي شامل</h1>
            <ol>
                <lh>يوجد لدينا العديد من البرامج السياحية حسب:</lh>
                <li>عدد الدول المراد زيارتها (دولة او اكثر)</li>
                <li>عدد الاشخاص</li>
                <li>عدد ايام البرنامج</li>
            </ol>
            <ol>
        ...
        <div class="pic"><img src="img/pic05.jpg"></div>
    </div>
    <!--end contents -->
    <table class="table">
