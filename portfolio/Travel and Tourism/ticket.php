<!DOCTYPE html>
    ...
    <div class="contents">
        <div class="text">
            <h1>تأمين تذاكر طيران</h1>
            <ol>
                <lh>يوجد لدينا العديد من تذاكر الطيران:</lh>
                <li>التذاكر الاقتصادية</li>
                <li>تذاكر رجال الاعمال</li>
                <li>تذاكر الدرجة الاولى</li>
            </ol>
            <ol>
                <lh>نتميز عن منافسينا:</lh>
                <li>رحلات يومية لكل انحاء العالم</li>
                <li>أفضل الاسعار المدروسة</li>
                <li>مستوى عال من الامان والمصداقية</li>
            </ol>
        </div>
        <div class="pic"><img src="img/pic02.jpg"></div>
    </div>
    <!--end contents -->
    <table class="table">
