<!DOCTYPE html>
    ...
    <div class="contents">
        <div class="text">
            <h1>خدمة تأجير السيارات</h1>
            <ol>
                <lh>يوجد لدينا العديد من خدمات التأجير حسب:</lh>
                <li>نوع السيارة</li>
                <li>عدد ايام الاستأجار</li>
                <li>وجود سائق ام لا</li>
            </ol>
            <ol>
        ...
        <div class="pic"><img src="img/pic06.jpg"></div>
    </div>
    <!--end contents -->
    <table class="table">
