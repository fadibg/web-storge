...
$result2= mysqli_query($db, "SELECT * FROM cars WHERE firstname = '1'");
...
{
  echo"      <img src=imgs/".$row['carimg']." alt='Forest' width='600' height='400'>";
  echo"    <div class='desc'>".$row['car']."</div>";
echo"<input type=hidden name='idcar' value='".$row['id']."'>";
echo"<input type=hidden name='price' value='".$row['rentprice']."'>";
echo"<input type='submit' name='' value='more....'>";
...
if($lin==4){$lin=1;if($li==true){$li=false;}else{$li=true;}}
echo"  </div>";
echo"</form>";
}
?>
