 ...
 <section id="breadcrumbs" class="breadcrumbs">
      ...
      <div class='container'>
        ...
        <div class='row'>
          <div class='col-lg-12 d-flex justify-content-center'>
            <ul id='portfolio-flters' class='filter'>
              <li id='a' data-filter='*' class='filter-active'>All</li>
              <li id='wd' data-filter='.1' >Develop Web Sites</li>
              <li id='gr' data-filter='.2'>Graphic Design</li>
              <li id='da' data-filter='.3' >Data Analyeses</li>
              <li id='s' data-filter='.4'>supportive</li>
            </ul>
          </div>
        </div>
  ...
  <div class='container'>
    ...
    <div class='row'>
      <div class='col-lg-12 d-flex justify-content-center'>
        <ul id='portfolio-flters' class='filter'>
          <li id='a' data-filter='*' >All</li>
          <li id='wd' data-filter='.1' class='filter-active' >Develop Web Sites</li>
          <li id='gr' data-filter='.2'>Graphic Design</li>
          <li id='da' data-filter='.3' >Data Analyeses</li>
          <li id='s' data-filter='.4'>supportive</li>
        </ul>
...
<div class='row'>
  <div class='col-lg-12 d-flex justify-content-center'>
    <ul id='portfolio-flters' class='filter'>
      <li id='a' data-filter='*' >All</li>
      <li id='wd' data-filter='.1' >Develop Web Sites</li>
      <li id='gr' data-filter='.2' class='filter-active'>Graphic Design</li>
      <li id='da' data-filter='.3' >Data Analyeses</li>
      <li id='s' data-filter='.4'>supportive</li>
    </ul>
  </div>
...
<ul id='portfolio-flters' class='filter'>
  ...
  <li id='wd' data-filter='.1' >Develop Web Sites</li>
  <li id='gr' data-filter='.2'>Graphic Design</li>
  <li id='da' data-filter='.3' class='filter-active'>Data Analyeses</li>
  <li id='s' data-filter='.4'>supportive</li>
</ul>
</div>
</div>
...
<ul id='portfolio-flters' class='filter'>
  ...
  <li id='gr' data-filter='.2'>Graphic Design</li>
  <li id='da' data-filter='.3' >Data Analyeses</li>
  <li id='s' data-filter='.4' class='filter-active'>supportive</li>
</ul>
</div>
</div>
...
break;
          ...
          <div class='col-lg-4 col-md-6 portfolio-item ".$row["category"]."'>
            <div class='portfolio-wrap'>
              <img src=imgs/".$row["simage"]." class='img-fluid' alt=''>
              <div class='portfolio-info'>
                 <h4>".$row["namep"]."</h4>
                <p></p>
                <div class='portfolio-links'>
                <a href='portfolio-details.php?id=".$row["id_project"]."' title='More Details'><i class='bx bx-link'></i></a>
                </div>
              </div>
            </div>
          </div>
